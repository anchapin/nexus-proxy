...
If you have [Homebrew](https://brew.sh) installed, this is the fastest
...
The formula is auto-generated by GoReleaser on each tagged release and
published to the [`anchapin/homebrew-nexus`](https://github.com/anchapin/homebrew-nexus)
tap. The `sha256` is pinned from release checksums automatically.
...
Alternatively, `go install` works if you have a Go toolchain. Nexus is
pure Go (CGO-free):
