...
| `nexus_frontier_circuit_close_total` | counter | `provider` | N providers | `collector.go` (issue #1412) |
...
**Maximum theoretical series**: 24 + 96 + 8 + 2 + 1 + 2 + 1 + 1 + 4 + 6 + 4 + 1 + 2 + 2 + 1 + 1 + 1 + 2 + 1 + N = 164 + N series (the additional N comes from `nexus_frontier_circuit_close_total{provider}` per frontier provider, issue #1412).
